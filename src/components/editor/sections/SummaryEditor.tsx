        ...
        <div className="space-y-4">
            <div className="flex justify-between items-center border-b pb-2">
                <div className="space-y-1">
                    <h3 className="text-lg font-semibold text-gray-800 tracking-tight">Professional Summary</h3>
            ...
            <div className="relative group">
                <textarea
                    ...
                    className="w-full h-44 border border-gray-200 p-4 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all resize-none shadow-inner bg-gray-50/30 text-gray-700 leading-relaxed font-medium"
