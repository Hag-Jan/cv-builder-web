...
export const STOPWORDS = new Set([
    ...
    "job", "position", "role", "candidate", "applicant", "seeking", "looking",
    "required", "preferred", "must", "should", "include", "includes", "including",
    "responsibilities", "requirements", "qualifications", "skills", "experience",
    "years", "year", "work", "working", "ability", "strong", "excellent", "good"
]);
